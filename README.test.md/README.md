[//]: <> (  DO NOT EDIT! Autogenerated and auto-replaced from source docs/README.md, write docs there instead)
...
This is beta version **0.8.3-SNAPSHOT**.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:0.8.3-SNAPSHOT'
}
```
...
```properties
version = 0.8.3-SNAPSHOT-SNAPSHOT
```
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:0.8.3-SNAPSHOT-SNAPSHOT'
}
```
...
Note: `react4xp@0.2.0` corresponds with lib-react4xp version 0.8.3-SNAPSHOT. For other versions of this lib, see [the table of corresponding versions](#version-and-compatibility) above.
