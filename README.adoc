...
Again, if you're using a different version of this library than 3.0.0-SNAPSHOT, the NPM package may need a different, matching version than `@enonic/react4xp`. See link:#versions-and-compatibility[above].
