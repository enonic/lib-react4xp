[//]: <> (lib-react4xp readme: USE THIS FILE TO EDIT THE ROOT's README.md! This will be copied to root and and verions inserted before commit. Gradle task: copyReadme. Version placeholder: ###LIB_VERSION###. Leave this line in place)
...
Again, if you're using a different version of this library than ###LIB_VERSION###, the NPM package may need a different, matching version than `@enonic/react4xp`. See [above](#versions-and-compatibility).
