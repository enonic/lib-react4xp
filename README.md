...
This is version **2.0.0** for XP 7.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:2.0.0'
}
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:2.0.0-SNAPSHOT'
...
```commandline
npm install --save-dev react4xp@2.0.0
```

Again, if you're using a different version of this library than 2.0.0, the NPM package may need a different, matching version than `react4xp@2.0.0`. See [above](#versions-and-compatibility).
