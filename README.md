...
This is version **1.5.0-SNAPSHOT** for XP 7.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:1.5.0-SNAPSHOT'
}
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:1.5.0-SNAPSHOT-SNAPSHOT'
}
```
...
```commandline
npm install --save-dev react4xp@1.5.4
```

Again, if you're using a different version of this library than 1.5.0-SNAPSHOT, the NPM package may need a different, matching version than `react4xp@1.5.4`. See [above](#versions-and-compatibility).
