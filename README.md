...
This is version **1.0.0-RC3** for XP 7.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:1.0.0-RC3'
}
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:1.0.0-RC3-SNAPSHOT'
}
```
...
Again, if you're using a different version of this library than 1.0.0-RC3, the NPM package may need a different, matching version than `react4xp@1.0.0`. See [above](#versions-and-compatibility).
