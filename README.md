[//]: <> (lib-react4xp readme: USE THIS FILE TO EDIT THE ROOT's README.md! This will be copied to root and and verions inserted before commit. Gradle task: copyReadme. Version placeholder: 3.0.0-SNAPSHOT. Leave this line in place)
...
This is version **3.0.0-SNAPSHOT** for XP 7.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:3.0.0-SNAPSHOT'
}
...
```properties
version = 3.0.0-SNAPSHOT-SNAPSHOT
```
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:3.0.0-SNAPSHOT-SNAPSHOT'
...
Again, if you're using a different version of this library than 3.0.0-SNAPSHOT, the NPM package may need a different, matching version than `@enonic/react4xp`. See [above](#versions-and-compatibility).
