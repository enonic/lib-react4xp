[//]: <> (  DO NOT EDIT! Autogenerated and auto-replaced from source docs/README.src.md, write docs there instead!  )
...
Note: `react4xp@0.2.0` corresponds with lib-react4xp version 0.9.0. For other versions of this lib, see [the table of corresponding versions](#versions-and-compatibility) above.
