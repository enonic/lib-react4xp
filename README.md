...
This is version **1.0.0-RC2** for XP 7.
...
```groovy
dependencies {
	include 'com.enonic.lib:lib-react4xp:1.0.0-RC2'
}
...
```groovy
dependencies {
    include 'com.enonic.lib:lib-react4xp:1.0.0-RC2-SNAPSHOT'
}
```
...
Again, if you're using a different version of this library than 1.0.0-RC2, the NPM package may need a different, matching version than `react4xp@1.0.0`. See [above](#versions-and-compatibility).
